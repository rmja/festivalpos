...
export function setup(state: State, options: { terminalId: number, pointOfSaleId: number, sumupAffiliateKey?: string, sumupReceiptEmail?: string, mobilepayNumber?: number }) {
    const newState = Object.assign({}, state);
