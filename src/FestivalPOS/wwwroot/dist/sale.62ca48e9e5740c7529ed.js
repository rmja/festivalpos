...
var Products = /** @class */ (function () {
    ...
    Products.prototype.stateChanged = function (state) {
        var _loop_1 = function (product) {
            var qty = state.orderLines.filter(function (x) { return x.productId === product.id; }).reduce(function (sum, line) { return sum + line.quantity; }, 0);
            product.qty;
        };
